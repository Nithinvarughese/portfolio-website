...
interface LiquidEtherProps {
    ...
    [key: string]: any; // Allow extra props like color0 etc that user might pass
}
...
`;
        ...
        class Advection extends ShaderPass {
            ...
            update(opts?: { dt: number, isBounce: boolean, BFECC: boolean }) { // Added opts
                if (!opts || !this.line) return;
                this.uniforms.dt.value = opts.dt;
                this.line.visible = opts.isBounce;
                this.uniforms.isBFECC.value = opts.BFECC; // Changed from BFECC to opts.BFECC
                super.update();
            }
        }
        ...
        class ExternalForce extends ShaderPass {
            ...
            init(simProps?: any) { // Added simProps arg
                super.init();
        ...
        // Cleanup existing children if any to prevent duplicates if strict mode double invokes
